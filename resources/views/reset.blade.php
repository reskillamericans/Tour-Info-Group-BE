...
<body>
  ...
  <header class="header">
    <div class="menu">
        <a href="#"><img src="{{asset('img/pinnacle.png')}}" alt="Touryst Logo"></a>
        <ul class="right">
            <li><a href="#">Home</a></li>
...
<div class="wrapper">
  ...
  <div class="box1">
    <div class="box2">
      <img src="pinnacle.png" alt="picture">
      <p>Reset your password, click the link below</p>
      <img src="Vector.png" alt="Pic of Boy">
      <div>
